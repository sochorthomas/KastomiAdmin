    ...
    <div class="footer_container">
      ...
      <div class="footer_logo" style="text-align: center">
        <a href="https://kastomi.com/">
          <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 755.5 375.35" style="width: 40%; margin: auto" class="kastomi-logo-svg">
            <g>
              ...
              <path class="cls-1" d="m143.66,24.73c0,13.65-11.07,24.73-24.73,24.73s-24.73-11.07-24.73-24.73S105.27,0,118.93,0s24.73,11.07,24.73,24.73Z"/>
            </g>
            <g>
      ...
      <div class="footer_conditions">
        <div class="footer-udaje">
          ...
          <a href="https://kastomi.com/ochrana-udaju.html"><h5>Ochrana osobních údajů (GDPR)</h5></a>
          <a href="https://kastomi.com/obchodni-podminky.html"><h5>Obchodní podmínky</h5></a>
...
<script setup>
// No JavaScript needed for static footer
</script>

<style scoped>
/* SVG Path Styles */
.kastomi-logo-svg .cls-1 {
  stroke: none;
